            ...
            <div className="w-full h-32 bg-zinc-900 flex flex-row justify-center items-center">
                <div className="flex space-x-10 mb-8 mt-3">
                    ...
                    <div className="w-56 h-20 -ml-7 text-center mt-5">
                        <p className="text-black text-2xl font-extrabold font-jost capitalize">MONTHS</p>
                        <p className="text-black text-5xl font-extrabold font-jost capitalize">02</p>
                    </div>
                    </div>
                    <div className="w-40 h-28 bg-teal-300 rounded-[10px] justify-around">
                    <div className="w-56 h-20 text-center -ml-8 mt-5">
                        <p className="text-black text-2xl font-extrabold font-jost capitalize">DAYS</p>
                        <p className="text-black text-5xl font-extrabold font-jost capitalize">01</p>
                    </div>
                    </div>
                </div>
            </div>
