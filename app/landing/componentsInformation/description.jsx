        ...
        <div className=" bg-black shadow w-full h-5/6 px-20">
            ...
            <div className="w-full h-128 bg-zinc-900 flex flex-row flex-nowrap justify-around"> 
                ...
                <div className="w-3/5 h-128 flex justify-center mr-5 mt-8 ">
                    <Image isZoomed isBlurred width={380} alt="NextUI Fruit Image with Zoom" src="https://images.unsplash.com/photo-1494390248081-4e521a5940db?auto=format&fit=crop&q=80&w=2006&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"/>
                </div>
                ...
                <p className="w-1/2 text-white text-[17px] font-normal font-['Istok Web'] capitalize  mt-16 mr-36 text-justify"
                    ...
                    active life with information available in one place.  </p>
